...
<body>
    <nav class="relative px-4 py-4 flex justify-between items-center bg-gray-100">
        ...
        <a class="hidden lg:inline-block lg:ml-auto  py-2 px-6 bg-green-500 text-white hover:bg-gray-100 text-sm text-gray-900 font-bold rounded-xl transition duration-200"
            href="#">Sign In</a>
