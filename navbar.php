...
<body>
    <nav class="relative px-4 py-4 flex justify-between items-center bg-gray-100">
        ...
        <a class="hidden lg:inline-block lg:ml-auto  py-2 px-6 bg-green-600 text-white hover:bg-gray-100 text-sm  font-bold rounded-xl transition duration-200"
            href="./loin.phpg">Sign In</a>
        <a class="hidden lg:inline-block  py-2 px-6 ml-2 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold rounded-xl transition duration-200"
